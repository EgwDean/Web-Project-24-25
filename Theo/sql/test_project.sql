...
VALUES 
  ('giannis.georgiou@student.edu', 101, 'canceled', '2024-09-01', '2024-12-01', 'https://link1.com', 'pdf1.pdf', 'link1.com'),
...
(3, 'dimitris.papa@university.edu', 'pa@university.edu', 'Sofia Liasidou'),
(4, 'Minister Ioannis Papanikolaou', 'Vasilis Georgiou', 'dimitris.papa@university.edu'),
(5, 'allos', 'dimitris.papa@university.edu', 'Sofia Liasidou'),
(6, 'Minister Ioannis Papanikolaou', 'akyro atomo', 'eimai xazos');
...
('mary.smith@example.com', 2, 'under examination', '2024-03-01', '2025-1-1', 'http://example.com/nemertes/102', 'path/to/diploma2.pdf', 'http://example.com/external_link2'),
('peter.jones@example.com', 3, 'active', '2024-02-20', '2026-1-1', NULL, 'path/to/diploma3.pdf', 'http://example.com/external_link3'),
('lucy.brown@example.com', 4, 'pending', '2024-04-10', '2024-10-10', '', 'path/to/diploma4.pdf', 'http://example.com/external_link4'),

	...
	<div class="button-container">
        ...
        <div class="create-form">
	     <h2>Δημιουργία Νέας Διπλωματικής</h2>
            <form method="POST" action="insert_diplomatic.php">
                <div>
                ...
                <div class="button-container">
                    ...
                    <button type="button" class="cancel-btn" onclick="cancelCreate()">Cancel</button>
                </div>
            </form>
        </div>
	    ...
	    <h2>Επεξεργασία Διπλωματικής</h2>
            <form method="POST" action="update_diplomatic.php">
                <div>

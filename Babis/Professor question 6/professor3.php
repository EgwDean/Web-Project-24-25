                ...
                if (xhr.status === 200) {
                    ...
                    data.forEach(item => {
                        ...
                        row.onclick = function (event) {
							...
							rowClickHandler(event);  // συνάρτηση που γεμίζει αυτόματα την φόρμα σημειώσεων σε κάθε 'click' σε γραμμή
                        };
...
<div style="margin-bottom: 20px;">
    ...
    <table id="item_table"></table>
            ...
            <div class="export-btn-container">
				...
				<button class="export-btn" id="notes_btn" onclick="showNotesForm()" style="display: none;">Notes</button>

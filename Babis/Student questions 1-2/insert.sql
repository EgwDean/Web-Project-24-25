...
# Δουλειά του PROFESSOR 2.), την οποία έκανα χειροκίνητα
...
# Δουλειά του ΦΟΙΤΗΤΗΣ 3.) ΥΠΟ ΑΝΑΘΕΣΗ, την οποία έκανα χειροκίνητα
...
# Δουλειά του ΦΟΙΤΗΤΗ 3.) ΥΠΟ ΑΝΑΘΕΣΗ, ΠΟΥ ΥΛΟΠΟΙΗΘΗΚΕ ΤΕΛΙΚΑ ΣΤΟΝ ΚΑΘΗΓΗΤΗ, την οποία έκανα χειροκίνητα
...
# Δουλειά του ΦΟΙΤΗΤΗ 3.) ΥΠΟ ΕΞΕΤΑΣΗ, την οποία έκανα χειροκίνητα

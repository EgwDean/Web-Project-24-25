...
# Ερώτημα 6 (Ενεργή) --> Πρόσθεση Σημειώσεων ΜΟΝΟ από καθηγητές/μέλη τριμελούς της οριζόμενης διπλωματικής
...
# Ερώτημα 6 (Υπό Εξέταση) -->  Τρέξε το insert.sql μετά το triggers.sql
...
# δημιουργήθηκε trigger που υλοποιεί το παραπάνω κάθε φορά που πάει να γίνει εισαγωγή εγγραφών στον πίνακα eksetasi_diplomatikis που οι ΒΑΘΜΟΙ δεν είναι NULL.

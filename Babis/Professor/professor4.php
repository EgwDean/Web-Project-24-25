...
<form id="studentForm" action="accept.php" method="POST" class="form-container">
    <h2>Απάντηση σε αίτηση τριμελής</h2>
    
    <label for="Id">ID</label>
    <input type="text" id="Id" name="Id" placeholder="ID Διπλωματικής" class="form-input" required readonly>
    
    <div class="button-wrapper">
        <button type="submit" class="form-button submit-btn" onclick="setFormAction('accept.php')">Accept</button>
        <button type="submit" class="form-button clear-btn" onclick="setFormAction('decline.php')">Decline</button>
    </div>
</form>

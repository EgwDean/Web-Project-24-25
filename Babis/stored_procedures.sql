...
SELECT committee.supervisor INTO supervisor FROM committee 
WHERE committee.id_dipl = id_diploma;
...
SELECT committee.member1 INTO member1 FROM committee 
WHERE committee.id_dipl = id_diploma;

SELECT committee.member2 INTO member2 FROM committee 
WHERE committee.id_dipl = id_diploma;

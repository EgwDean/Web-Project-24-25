...
VALUES
  ('s1', 'Giannis', 'Georgiou', 1001, 'Main St', '5A', 'Athens', '10432', 'Nikolaos', '2106543210', '6906543210', 'peter.jones@example.com'),
  ('s2', 'Eleni', 'Papadaki', 1002, 'Oak St', '12B', 'Thessaloniki', '54635', 'Manolis', '2310123456', '6907654321', 'mary.smith@example.com'),
  ...
  ('secure567', 'Jane', 'Smith', 1002, 'Elm Avenue', '20', 'Los Angeles', '90001', 'William Smith', NULL, '8765432109', 'lucy.brown@example.com'),
...
VALUES
  ('dimitris.papa@university.edu', 'Quantum Physics in Computation', 'This thesis explores the applications of quantum mechanics in modern computational theory.', '../uploads/pdf_link_topic/1.pdf', 'available'),
  ('dimitris.papa@university.edu', 'Advanced Topics in Algebra', 'A detailed analysis of modern algebraic structures and their applications in cryptography.', '../uploads/pdf_link_topic/2.pdf', 'available'),
  ('dimitris.papa@university.edu', 'Artificial Intelligence Ethics', 'An in-depth study on the ethical implications of artificial intelligence and machine learning.', '../uploads/pdf_link_topic/3.pdf', 'available'),
...
INSERT INTO eksetasi_diplomatikis 
VALUES 
(1, 'john.doe@example.com', '2024-11-27 10:00:00', 'Room A', 8.50, 9.00, 9.50, 9.00, 'Pass'),
(2, 'mary.smith@example.com', '2024-11-28 14:00:00', 'Room B', 7.00, 8.00, 7.50, 7.50, 'Pass'),
(3, 'peter.jones@example.com', '2024-11-30 14:00:00', 'Room B', 7.00, 8.00, 7.50, 7.50, 'Pass'),
(4, 'john.doe@example.com', '2024-11-29 09:00:00', 'Room C', NULL, NULL, NULL, NULL, NULL);
...
SELECT CONCAT(student.name, ' ', student.surname) AS student_full_name,number,id_diplomatikis AS id,title,exam_date,exam_room,CONCAT(professor.name, ' ', professor.surname) AS professor_full_name,
...
('lucy.brown@example.com', 4, 'under examination', '2024-04-10', '2024-10-10', 'http://example.com/nemertes/104', 'path/to/diploma4.pdf', 'http://example.com/external_link4'),
('lucy.brown@example.com', 5, 'active', '2020-04-10', NULL, 'http://example.com/nemertes/104', 'path/to/diploma4.pdf', 'http://example.com/external_link4, http://example.com/external_link4, http://example.com/external_link4'),
('n@example.com', 5, 'recalled', '2024-04-10', NULL, 'http://example.com/nemertes/104', 'path/to/diploma4.pdf', 'http://example.com/external_link4');
...
('mike.brown@example.com', 'some', 4, 'pending', '2024-11-10', '2024-11-05');

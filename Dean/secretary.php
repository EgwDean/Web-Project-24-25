...
$conn = new mysqli($host, $dbusername, $dbpassword, $dbname); // Σύνδεση στη βάση
...
function get() { // Κατασευή πίνκα και γέμισμα με διπλωματικές
  ...
  function renderTable(items) {
    ...
    items.forEach(item => {
      ...
      row.addEventListener('click', function () {
        ...
        detailsActionButton.classList.add("details-button");
      });
    });
  }
